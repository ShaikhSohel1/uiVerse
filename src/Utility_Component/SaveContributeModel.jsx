...
export default function SaveContributeModel({open, setOpen, onSave,setPostTitle}) {
  ...
  <div className="flex flex-wrap ">
    <div className="w-full px-3 mb-6 md:mb-0">
      ...
      <textarea
      className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Give Description about Contribution" 
