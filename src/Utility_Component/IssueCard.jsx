      ...
      <div class="w-full max-w-sm border-none flex mx-16">
        ...
        <div class="flex flex-col items-center pb-10 justify-center">
          ...
          <div class="flex mt-4 space-x-3 md:mt-6">
            <button
              class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300  "
              onClick={mergeData}
            >
              Merge
            </button>
