...
export default function SavePostModel({open, setOpen, setelementType, setPostTitle, onSave}) {
  ...
  <div className="flex flex-wrap -mx-3">
    <div className="w-full px-3 mb-6 md:mb-0">
      ...
      <input 
      className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Post Title" 
  ...
  <div className="flex flex-wrap -mx-3 mb-2">
    ...
    <div className="w-full px-3 mb-6 md:mb-0">
      ...
      <div className="relative">
        ...
        >
            {elements.map((i) => (
                <option key={i}>{i.ElementName}</option>
            ))}
        </select>
