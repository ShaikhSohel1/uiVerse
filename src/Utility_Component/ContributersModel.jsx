...
export default function ContributionModel({open, setOpen, contributersList}) {
  ...
  <div class="flex flex-wrap ">
    {contributersList && contributersList.map((i) => (
        <div key={i} class="w-full px-3 mb-6 md:mb-0 flex gap-5">
        <img className="w-12 h-12  mb-3 rounded-full shadow-lg" src={i.UserImage} alt="alt"/>
          <p class=" tracking-wide text-gray-700 text-md font-medium mb-2 flex items-center" for="grid-first-name">
            {i.UserName}
          </p>
